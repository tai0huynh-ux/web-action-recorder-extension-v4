export const controllerFiles = [
  ...
  'platform/controller-electron/src/controllerHost.js',
  ...
  'platform/controller-electron/src/runtimeProfileStore.js',
  ...
  'platform/controller-electron/renderer/remoteControl.js',
...
export const browserAgentFiles = [
  ...
  'platform/browser-agent/cloakbrowser-provenance.json',
  'platform/browser-agent/xclip-source.json',
  ...
  'platform/container/security/chromium-userns-seccomp.json',
  'platform/container/security/war-browser-agent.apparmor',
  'scripts/ci/generate-image-sbom.mjs',
  'scripts/ci/generate-image-sbom-for-docker.mjs',
  'platform/protocol/src/protocolV2.js',
