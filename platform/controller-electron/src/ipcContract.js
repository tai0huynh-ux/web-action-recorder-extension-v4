...
export const IPC_CHANNELS = deepFreeze({
  ...
  pairings: {
    ...
    reconnect: `${CHANNEL_PREFIX}pairings:reconnect`,
  },
  devices: {
  ...
  containers: {
    ...
    hostReconnect: `${CHANNEL_PREFIX}containers:host-reconnect`,
    ...
    scan: `${CHANNEL_PREFIX}containers:scan`,
    ...
    reconnect: `${CHANNEL_PREFIX}containers:reconnect`,
    repair: `${CHANNEL_PREFIX}containers:repair`,
  ...
  diagnostics: {
    run: `${CHANNEL_PREFIX}diagnostics:run`,
    repair: `${CHANNEL_PREFIX}diagnostics:repair`,
  },
  dialog: {
...
export const REQUEST_CHANNELS = deepFreeze([
  ...
  IPC_CHANNELS.pairings.reconnect,
  ...
  IPC_CHANNELS.containers.hostReconnect,
  ...
  IPC_CHANNELS.diagnostics.run,
  IPC_CHANNELS.diagnostics.repair,
...
const CHANNEL_SCHEMAS = new Map([
  ...
  [IPC_CHANNELS.pairings.reconnect, objectSchema({ deviceId: 'id' })],
  ...
  [IPC_CHANNELS.containers.hostReconnect, objectSchema({ hostId: 'id' })],
  ...
  [IPC_CHANNELS.containers.scan, objectSchema({ hostId: 'id' })],
  ...
  [IPC_CHANNELS.containers.reconnect, objectSchema({ containerId: 'id' })],
  [IPC_CHANNELS.containers.repair, objectSchema({ containerId: 'id' })],
  ...
  [IPC_CHANNELS.diagnostics.run, NO_PAYLOAD],
  [IPC_CHANNELS.diagnostics.repair, objectSchema({ targetId: 'optionalString' })],
