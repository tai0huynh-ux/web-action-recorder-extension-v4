...
test('preload exposes only the warController global with the exact API shape', () => {
  ...
  assert.deepEqual(publicShape(api), {
    ...
    pairings: ['confirm', 'list', 'reconnect', 'reject', 'request', 'revoke'],
    devices: ['get', 'list'],
    settings: ['get', 'update'],
    sessions: ['list'],
    remote: ['capture', 'control', 'copyFromBrowser', 'openInteractive', 'openWindow', 'pasteToBrowser'],
    containers: ['add', 'addHost', 'checkHost', 'delete', 'duplicate', 'hosts', 'list', 'purge', 'purgeHost', 'reconnect', 'reconnectHost', 'refresh', 'repair', 'repairHost', 'restart', 'restore', 'restoreHost', 'scan', 'start', 'stop', 'trash', 'trashHost', 'updateHost', 'updateNetwork'],
...
test('preload methods invoke the fixed IPC contract channels with intact payloads', async () => {
  ...
  const methods = [
    ...
    [api.pairings.reconnect, IPC_CHANNELS.pairings.reconnect],
    ...
    [api.remote.capture, IPC_CHANNELS.remote.capture],
    [api.remote.control, IPC_CHANNELS.remote.control],
    [api.remote.copyFromBrowser, IPC_CHANNELS.remote.clipboardCopy],
    [api.remote.openInteractive, IPC_CHANNELS.remote.openInteractive],
    [api.remote.openWindow, IPC_CHANNELS.remote.openWindow],
    [api.remote.pasteToBrowser, IPC_CHANNELS.remote.clipboardPaste],
    [api.containers.list, IPC_CHANNELS.containers.list],
    [api.containers.trash, IPC_CHANNELS.containers.trash],
    [api.containers.hosts, IPC_CHANNELS.containers.hosts],
    [api.containers.addHost, IPC_CHANNELS.containers.hostAdd],
    [api.containers.updateHost, IPC_CHANNELS.containers.hostUpdate],
    [api.containers.checkHost, IPC_CHANNELS.containers.hostCheck],
    [api.containers.reconnectHost, IPC_CHANNELS.containers.hostReconnect],
    [api.containers.repairHost, IPC_CHANNELS.containers.hostRepair],
    [api.containers.trashHost, IPC_CHANNELS.containers.hostTrash],
    [api.containers.restoreHost, IPC_CHANNELS.containers.hostRestore],
    [api.containers.purgeHost, IPC_CHANNELS.containers.hostPurge],
    ...
    [api.containers.reconnect, IPC_CHANNELS.containers.reconnect],
    [api.containers.repair, IPC_CHANNELS.containers.repair],
    [api.containers.refresh, IPC_CHANNELS.containers.refresh],
    [api.containers.updateNetwork, IPC_CHANNELS.containers.updateNetwork],
    [api.containers.duplicate, IPC_CHANNELS.containers.duplicate],
    [api.containers.delete, IPC_CHANNELS.containers.delete],
    [api.containers.restore, IPC_CHANNELS.containers.restore],
    [api.containers.purge, IPC_CHANNELS.containers.purge],
    [api.containers.scan, IPC_CHANNELS.containers.scan],
    ...
    [api.diagnostics.run, IPC_CHANNELS.diagnostics.run],
    [api.diagnostics.repair, IPC_CHANNELS.diagnostics.repair],
