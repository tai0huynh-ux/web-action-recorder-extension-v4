...
test('preload exposes only the warController global with the exact API shape', () => {
  ...
  assert.deepEqual(publicShape(api), {
    ...
    settings: ['get', 'update'],
    sessions: ['list'],
    containers: ['add', 'addHost', 'checkHost', 'delete', 'duplicate', 'hosts', 'list', 'purge', 'purgeHost', 'refresh', 'repairHost', 'restart', 'restore', 'restoreHost', 'start', 'stop', 'trash', 'trashHost', 'updateNetwork'],
